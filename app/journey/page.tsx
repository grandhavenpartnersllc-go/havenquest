            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              >
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-6 flex-1">
                  You&apos;re open to anywhere in the state. Tell us your lifestyle and budget and we&apos;ll match you to the right Texas community across 4 Texas metros and 80 cities.
                </p>
                <span
