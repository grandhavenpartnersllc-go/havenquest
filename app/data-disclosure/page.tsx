          ...
          <div className="space-y-5">
            ...
            <section className="bg-amber-50 border border-amber-100 rounded-2xl p-6">
              ...
              <p className="text-sm text-amber-800 leading-relaxed mb-2">
                HavenQuest is operated by American Victory Alliance, LLC — Austin, TX. All data is provided for informational purposes only and does not constitute financial, legal, or real estate advice. Scores are directional lifestyle guidance. How scores work:{' '}
                <Link href="/methodology" className="underline underline-offset-2">havenquest.co/methodology</Link>
              </p>
