        ...
        <div className="max-w-3xl mx-auto px-4 py-10">
          <div className="space-y-5">
            ...
            <section className="bg-white rounded-2xl border border-gray-100 p-6" style={cardStyle}>
              ...
              <h3 className="text-sm font-bold text-gray-800 mb-3">2.1 The 13 Lifestyle Category Scores</h3>
              <p className="text-sm text-gray-500 leading-relaxed mb-4">Every city in the HavenQuest database is scored on 13 lifestyle categories on a scale of 1 to 10. These scores are editorially assigned by HavenQuest based on the underlying data sources listed in Section 1. They are directional indicators, not precise measurements.</p>
              <div className="overflow-x-auto mb-6">
                <table className="w-full text-sm">
